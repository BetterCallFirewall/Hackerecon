...
type Observation struct {
	...
	// From Reflection (Phase 2) - added later, nil if not yet evaluated
	IsSignificant *bool  `json:"is_significant,omitempty" jsonschema:"description=nil=not evaluated, true=save, false=discard"`
	Hint          string `json:"hint,omitempty" jsonschema:"description=Actionable guidance if significant"`
